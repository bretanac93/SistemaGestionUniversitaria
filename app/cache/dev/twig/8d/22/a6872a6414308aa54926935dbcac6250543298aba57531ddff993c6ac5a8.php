...
/* GestionBundle:Profesor:index.html.twig */
class __TwigTemplate_8d22a6872a6414308aa54926935dbcac6250543298aba57531ddff993c6ac5a8 extends Twig_Template
{
    ...
    <table class=\"records_list\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("profesor_show", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
            echo "\">";
            ...
            echo "\">show</a>
                    ...
                    <li>
                        <a href=\"";
            // line 35
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("profesor_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
            echo "\">edit</a>
                    </li>
                </ul>
                </td>
    ...
    {
        return "GestionBundle:Profesor:index.html.twig";
    }
