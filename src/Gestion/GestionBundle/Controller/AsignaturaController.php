...
use Gestion\GestionBundle\Form\AsignaturaType;
...
class AsignaturaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GestionBundle:Asignatura')->findBy(array(
            'semestre' => '1'
            ));
        return $this->render('GestionBundle:Asignatura:index.html.twig', array(
            'entities' => $entities,
        ));

    }

    public function EvaluacionAsignaturaAction($AsignaturaId)
    {
        $em = $this->getDoctrine()->getManager();

        $evaluaciones = $em->getRepository('GestionBundle:Evaluacion')->findBy(array(
            'asignatura' => $AsignaturaId
            ));


        return $this->render('GestionBundle:Asignatura:EvaluacionAsignatura.html.twig',array(
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('GestionBundle:Asignatura:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GestionBundle:Asignatura')->find($id);
        ...
        return $this->render('GestionBundle:Asignatura:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GestionBundle:Asignatura:edit.html.twig', array(
            'entity'      => $entity,
